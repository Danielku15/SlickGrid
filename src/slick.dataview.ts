...
import * as SlickDataGroup from './slick.groupitemmetadataprovider';
...
class DataView {
    ...
    private idxById = new Slick.Map();   // indexes by id
    ...
    private bulkDeleteIds = new Slick.Map();
    ...
    // events
    public onSetItemsCalled = new Slick.Event();
    public onRowCountChanged = new Slick.Event();
    public onRowsChanged = new Slick.Event();
    public onRowsOrCountChanged = new Slick.Event();
    public onBeforePagingInfoChanged = new Slick.Event();
    public onPagingInfoChanged = new Slick.Event();
    public onGroupExpanded = new Slick.Event();
    public onGroupCollapsed = new Slick.Event();
    ...
    private processBulkDelete() {
        ...
        this.bulkDeleteIds = new Slick.Map();
    }
    ...
    public setGrouping(groupingInfo) {
        if (!this.options.groupItemMetadataProvider) {
            this.options.groupItemMetadataProvider = new SlickDataGroup.Data.GroupItemMetadataProvider();
        }
