...
import * as Slick from './slick.core'
 ...
 **/
export class Grid implements Slick.IColumnIndexAccess {
    private container;
    private data;
    private columns;
    private options;
    ...
    private internalInit() {
        ...
        this.treeColumns = new Slick.TreeColumns(this.columns);
    ...
    private getColWidth(columnDef, $gridCanvas, data) {
        ...
        if (this.canvas_context && columnDef.autoSize.widthEvalMode === Slick.WidthEvalMode.CanvasTextSize) {
    ...
    private trigger(evt, args: any = {}, e = new Slick.EventData()) {
        args.grid = self;
    ...
    private validateAndEnforceOptions() {
        ...
        if (this.options.forceFitColumns) {
            this.options.autosizeColsMode = Slick.GridAutosizeColsMode.LegacyForceFit;
    ...
    public resizeCanvas() {
        ...
        if (this.options.autosizeColsMode === Slick.GridAutosizeColsMode.LegacyForceFit) {
    ...
    public updateRowCount() {
        ...
        if (this.options.autosizeColsMode === Slick.GridAutosizeColsMode.LegacyForceFit && oldViewportHasVScroll != this.viewportHasVScroll) {
            this.autosizeColumns();
        }
    ...
    */
    ...
    // Events
    public onScroll = new Slick.Event();
    public onSort = new Slick.Event();
    public onHeaderMouseEnter = new Slick.Event();
    public onHeaderMouseLeave = new Slick.Event();
    public onHeaderContextMenu = new Slick.Event();
    public onHeaderClick = new Slick.Event();
    public onHeaderCellRendered = new Slick.Event();
    public onBeforeHeaderCellDestroy = new Slick.Event();
    public onHeaderRowCellRendered = new Slick.Event();
    public onFooterRowCellRendered = new Slick.Event();
    public onFooterContextMenu = new Slick.Event();
    public onFooterClick = new Slick.Event();
    public onBeforeHeaderRowCellDestroy = new Slick.Event();
    public onBeforeFooterRowCellDestroy = new Slick.Event();
    public onMouseEnter = new Slick.Event();
    public onMouseLeave = new Slick.Event();
    public onClick = new Slick.Event();
    public onDblClick = new Slick.Event();
    public onContextMenu = new Slick.Event();
    public onKeyDown = new Slick.Event();
    public onAddNewRow = new Slick.Event();
    public onBeforeAppendCell = new Slick.Event();
    public onValidationError = new Slick.Event();
    public onViewportChanged = new Slick.Event();
    public onColumnsReordered = new Slick.Event();
    public onColumnsDrag = new Slick.Event();
    public onColumnsResized = new Slick.Event();
    public onBeforeColumnsResize = new Slick.Event();
    public onCellChange = new Slick.Event();
    public onCompositeEditorChange = new Slick.Event();
    public onBeforeEditCell = new Slick.Event();
    public onBeforeCellEditorDestroy = new Slick.Event();
    public onBeforeDestroy = new Slick.Event();
    public onActiveCellChanged = new Slick.Event();
    public onActiveCellPositionChanged = new Slick.Event();
    public onDragInit = new Slick.Event();
    public onDragStart = new Slick.Event();
    public onDrag = new Slick.Event();
    public onDragEnd = new Slick.Event();
    public onSelectedRowsChanged = new Slick.Event();
    public onCellCssStylesChanged = new Slick.Event();
    public onAutosizeColumns = new Slick.Event();
    public onRendered = new Slick.Event();
    public onSetOptions = new Slick.Event();
